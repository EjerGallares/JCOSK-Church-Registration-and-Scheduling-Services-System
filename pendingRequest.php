...
<section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Pending members</span>
      </div>
  ...
  <table id="example" class="display" style="width:100%">
        <thead class="head">
            <tr>
                ...
                <th>Contact</th>
                <th>Date Register</th>
                <th><button type="submit" name="Approves" class="btn btn-success">Approve</button></th>
     ...
     <tr>
           ...
           <td>
              ...
              <td style="width:10px; text-align: center">
               <input type="checkbox" name="cb_approveAd[]" value="<?= $row['regUserID']; ?>">
            </td> 
              <td style="width:10px; text-align: center">
